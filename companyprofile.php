...
<head>
	...
	<link href="assets/css/stylecompprof.css" rel="stylesheet">
	<link href="assets/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
...
<body>
    ...
    <div class="border-right" id="sidebar-wrapper" style="background: url(assets/img/bg-dashboard-sidebar.jpg);">
      ...
      <div class="list-group list-group-flush" style="opacity: 0.8";> 
        ...
        <a href="companyprofile.php" class="list-group-item list-group-item-action active"><i class="fas fa-user"></i> Profil</a>
	...
	<div class="container container-fluid emp-profile">
            <form method="post">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>finprojofflicial@gmail.com</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
